...
# TradingAgents: AI Crypto Research Workstation
...
TradingAgents is being repositioned as a multi-agent crypto research workstation. It uses specialized LLM-powered analysts, deterministic market signals, and structured debate to help traders build, track, and review trade theses. It is not an autonomous trading platform: generated plans require human review and approval before any exchange action.
...
- The Thesis Editor/Portfolio layer produces an AI-generated trade thesis. The system does not autonomously send orders; execution, if added later, must be explicit and user-approved.
