...
| Mypy | PASS: `python -m mypy luna_workstation`; see [mypy log](release-evidence/0.3.0-2026-05-12/clean-clone-mypy.log) |
| Compile | PASS: `python -m compileall luna_workstation tests`; see [compile log](release-evidence/0.3.0-2026-05-12/clean-clone-compileall.log) |
