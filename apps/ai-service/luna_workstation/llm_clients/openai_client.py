...
from luna_workstation.config.providers import get_provider_defaults
from luna_workstation.exceptions import RateLimitError
...
class DeepSeekChatOpenAI(NormalizedChatOpenAI):
    ...
    2. **deepseek-reasoner has no tool_choice.** Structured output via
       ...
       (see ``luna_workstation/agents/utils/structured.py``).
    """
...
# Provider config is now centralized in luna_workstation.config.providers.
