...
from luna_workstation.dataflows.interface import (
    VENDOR_METHODS,
...
class TestRouteToVendorHistorical:
    ...
    def test_none_window_falls_back_to_plain_routing(self):
        ...
        with patch("luna_workstation.dataflows.interface.route_to_vendor") as mock_route:
    ...
    def test_valid_contract_dispatches_to_vendor(self):
        ...
        with patch("luna_workstation.dataflows.interface.route_to_vendor") as mock_route:
            ...
            with patch(
                "luna_workstation.dataflows.interface.get_config",
                return_value={
                ...
                with patch(
                    "luna_workstation.dataflows.interface.get_category_for_method",
                    return_value="crypto_ohlcv",
                ):
                    with patch(
                        "luna_workstation.dataflows.interface.get_vendor",
                        return_value="ccxt",
                    ):
