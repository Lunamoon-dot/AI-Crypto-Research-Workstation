    ...
    prompt = ChatPromptTemplate.from_messages(
        [
            (
                ...
                " If you or any other assistant has the FINAL SETUP PROPOSAL: **BUY/HOLD/SELL** or deliverable,"
                " prefix your response with FINAL SETUP PROPOSAL: **BUY/HOLD/SELL** so the team knows to stop."
