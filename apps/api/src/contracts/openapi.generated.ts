    ...
    schemas: {
      ...
      CreateSimulationRequest: {
        ...
        properties: {
          ...
          position_size: { $ref: '#/components/schemas/JsonRecord' },
          partial_take_profit: {
            type: 'array',
            items: {
              type: 'object',
      ...
      SimulationRunResponse: {
        ...
        properties: {
          ...
          analysis_snapshot: { $ref: '#/components/schemas/JsonRecord' },
          assumptions: { $ref: '#/components/schemas/JsonRecord' },
          market_data_snapshot: { $ref: '#/components/schemas/JsonRecord' },
          sample_identity: { $ref: '#/components/schemas/JsonRecord' },
          source_integrity_status: { type: 'string', enum: ['verified', 'failed', 'unknown'] },
          source_drift_after_start: { type: 'boolean' },
          source_hashes: { $ref: '#/components/schemas/JsonRecord' },
        },
      },
      PaperOrderResponse: {
        type: 'object',
