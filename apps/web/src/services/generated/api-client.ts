...
export interface ScenarioOutcomeSnapshotResponse {
  ...
  generated_at: string;
  settled_at: string;
  settlement_reason: 'expired' | 'invalidated' | 'target_hit' | 'risk_exit_hit' | 'missed_entry' | 'data_end' | 'manual_abandon';
  trigger_hit: boolean | null;
  ...
  execution_quality: 'not_simulated' | 'rule_following' | 'late_entry' | 'premature_entry' | 'missed_trigger' | 'insufficient_data';
