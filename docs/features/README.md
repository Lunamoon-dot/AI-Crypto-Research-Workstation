...
| Research Continuity | [research-continuity/v1.4/implementation-plan.md](research-continuity/v1.4/implementation-plan.md) | implemented | Thin report read model for compact default continuity views. |
