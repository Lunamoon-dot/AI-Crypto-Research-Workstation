...
def _make_execution_result(*args, **kwargs):
    ...
    This execution-prefixed name is intentionally retained as a compatibility
    seam while the core product remains planning-first.
    """
...
class ResearchAgentsGraph:
    ...
    def _log_state(self, trade_date, final_state):
        ...
        directory = Path(self.config["results_dir"]) / safe_ticker / "ResearchWorkspace_logs"
    ...
    def _execute_decision(self, final_state: dict) -> Optional[dict]:
        ...
        The research core routes to thesis planning; legacy callers may still
        invoke this method name until optional assisted execution is introduced.
        """
